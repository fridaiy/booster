...
booster::String Hex::encode(const booster::String& data, const char* alphabet) {
  booster::data::stream::BufferOutputStream ss(256);
...
booster::String Hex::decode(const booster::String& data, bool allowSeparators) {
  booster::data::stream::BufferOutputStream ss(256);

...
void Response::setConnectionUpgradeHandler(const std::shared_ptr<booster::network::ConnectionHandler>& handler) {
  m_connectionUpgradeHandler = handler;
}

std::shared_ptr<booster::network::ConnectionHandler> Response::getConnectionUpgradeHandler() {
...
booster::async::CoroutineStarter Response::sendAsync(const std::shared_ptr<Response>& _this,
                                                   const std::shared_ptr<data::stream::OutputStream>& stream,
                                                   const std::shared_ptr<booster::data::stream::BufferOutputStream>& headersWriteBuffer,

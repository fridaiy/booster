...
#ifndef booster_web_protocol_http_encoding_Chunked_hpp
#define booster_web_protocol_http_encoding_Chunked_hpp
...
public:
  ...
  booster::String getEncodingName() override;
...
#endif //booster_web_protocol_http_encoding_Chunked_hpp
